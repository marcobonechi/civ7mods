...
LANG["en_US"] = dict(
    ...
    maps=["Distant Lands: Africa, Scandinavia and Iceland lie across the water",
          ...
          "Eurasia Compressed: Russia and the Caspian become an Eastern Ocean, with China, Korea, Mongolia and Japan beyond it, where the East Asian civilizations start",
          "Eurasia Compressed (Distant Lands): the same, with East Asia, Scandinavia and Iceland as Distant Lands"],
...
LANG["de_DE"] = dict(
    ...
    maps=["Ferne Länder: Afrika, Skandinavien und Island liegen jenseits des Wassers",
          ...
          "Eurasien komprimiert: Russland und das Kaspische Meer werden ein Östlicher Ozean, dahinter China, Korea, die Mongolei und Japan, wo die ostasiatischen Zivilisationen beginnen",
          "Eurasien komprimiert (Ferne Länder): dasselbe, mit Ostasien, Skandinavien und Island als ferne Länder"],
...
LANG["es_ES"] = dict(
    ...
    maps=["Tierras Lejanas: África, Escandinavia e Islandia al otro lado del agua",
          ...
          "Eurasia comprimida: Rusia y el Caspio se convierten en un Océano Oriental y, al otro lado, China, Corea, Mongolia y Japón, donde empiezan las civilizaciones de Asia Oriental",
          "Eurasia comprimida (Tierras Lejanas): lo mismo, con Asia Oriental, Escandinavia e Islandia como tierras lejanas"],
...
LANG["fr_FR"] = dict(
    ...
    maps=["Terres lointaines : l'Afrique, la Scandinavie et l'Islande de l'autre côté de l'eau",
          ...
          "Eurasie compressée : la Russie et la Caspienne deviennent un océan Oriental, avec au-delà la Chine, la Corée, la Mongolie et le Japon, où commencent les civilisations d'Asie orientale",
          "Eurasie compressée (Terres lointaines) : la même, avec l'Asie orientale, la Scandinavie et l'Islande en terres lointaines"],
...
LANG["it_IT"] = dict(
    ...
    maps=["Terre Lontane: Africa, Scandinavia e Islanda oltre il mare",
          ...
          "Eurasia compressa: la Russia e il Caspio diventano un Oceano Orientale, e al di là Cina, Corea, Mongolia e Giappone, dove partono le civiltà dell'Asia orientale",
          "Eurasia compressa (Terre lontane): la stessa, con Asia orientale, Scandinavia e Islanda come terre lontane"],
...
LANG["pl_PL"] = dict(
    ...
    maps=["Dalekie Ziemie: Afryka, Skandynawia i Islandia po drugiej stronie wody",
          ...
          "Eurazja skompresowana: Rosja i Morze Kaspijskie stają się Oceanem Wschodnim, a za nim Chiny, Korea, Mongolia i Japonia, gdzie zaczynają cywilizacje Azji Wschodniej",
          "Eurazja skompresowana (Dalekie Ziemie): to samo, z Azją Wschodnią, Skandynawią i Islandią jako dalekimi ziemiami"],
...
LANG["pt_BR"] = dict(
    ...
    maps=["Terras Distantes: África, Escandinávia e Islândia do outro lado da água",
          ...
          "Eurásia comprimida: a Rússia e o Cáspio viram um Oceano Oriental e, além dele, China, Coreia, Mongólia e Japão, onde começam as civilizações da Ásia Oriental",
          "Eurásia comprimida (Terras Distantes): o mesmo, com a Ásia Oriental, a Escandinávia e a Islândia como terras distantes"],
...
LANG["uk_UA"] = dict(
    ...
    maps=["Далекі землі: Африка, Скандинавія та Ісландія за водою",
          ...
          "Стиснута Євразія: Росія й Каспій стають Східним океаном, а за ним — Китай, Корея, Монголія та Японія, де починають цивілізації Східної Азії",
          "Стиснута Євразія (Далекі землі): те саме, зі Східною Азією, Скандинавією та Ісландією як далекими землями"],
...
LANG["ja_JP"] = dict(
    ...
    maps=["遠方の地：アフリカ、スカンディナヴィア、アイスランドが海の向こう",
          ...
          "圧縮ユーラシア：ロシアとカスピ海は東の大洋となり、その向こうの中国、朝鮮、モンゴル、日本で東アジアの文明が始まる",
          "圧縮ユーラシア（遠方の地）：同じ地形で、東アジア、スカンディナヴィア、アイスランドが遠方の地"],
...
LANG["ko_KR"] = dict(
    ...
    maps=["먼 땅: 아프리카, 스칸디나비아, 아이슬란드가 바다 건너편",
          ...
          "압축된 유라시아: 러시아와 카스피해가 동쪽 대양이 되고, 그 너머 중국, 한국, 몽골, 일본에서 동아시아 문명이 시작",
          "압축된 유라시아 (먼 땅): 같은 지형에 동아시아, 스칸디나비아, 아이슬란드가 먼 땅"],
...
LANG["zh_Hans_CN"] = dict(
    ...
    maps=["远方大陆：非洲、斯堪的纳维亚与冰岛隔海相望",
          ...
          "压缩欧亚大陆：俄罗斯和里海化为东方大洋，彼岸的中国、朝鲜半岛、蒙古和日本是东亚文明的起点",
          "压缩欧亚大陆（远方大陆）：地形相同，东亚、斯堪的纳维亚和冰岛为远方大陆"],
...
LANG["zh_Hant_HK"] = dict(
    ...
    maps=["遠方大陸：非洲、斯堪的納維亞與冰島隔海相望",
          ...
          "壓縮歐亞大陸：俄羅斯和裏海化為東方大洋，彼岸的中國、朝鮮半島、蒙古和日本是東亞文明的起點",
          "壓縮歐亞大陸（遠方大陸）：地形相同，東亞、斯堪的納維亞和冰島為遠方大陸"],
