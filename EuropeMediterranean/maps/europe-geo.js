...
export const GEO = {
    ...
    ranges: [
        ...
        // The Carpathians in segments rather than one uniform line, as on the Large maps: high in a
        // couple of places and moderate everywhere else, which is what the range is - crossed all
        // along by low passes (the Moravian Gate at 310m, Dukla at 500m, Uzhok, Prislop).
        //
        // The cores here are lower than the Large maps' (0.35/0.4/0.55 against 0.3/0.35/0.8),
        // because this map has no rangeScale: authored values are taken literally on a 78-column
        // grid where one hex is a full degree of longitude, so a core of 0.8 would render the
        // Fagaras as a thicker wall than the single line it replaced, not a thinner one. Capping
        // every segment at the old 0.55 keeps the high places high and thins the rest.
        { name: "Carpathians (Beskids)", core: 0.35, fringe: 1.1, pts: [[17.0, 49.4], [19.0, 49.4], [20.5, 49.2], [22.0, 49.0], [23.5, 48.4]] },
        { name: "Carpathians (eastern)", core: 0.4, fringe: 1.15, pts: [[23.5, 48.4], [24.5, 47.7], [25.5, 47.0], [26.0, 46.2], [25.8, 45.5]] },
        // The two genuinely high places. Southern Carpathians: Fagaras (Moldoveanu 2544m), Parang
        // and Retezat, an unbroken 2000m+ wall above the Wallachian plain. Rodna and Chornohora:
        // Pietrosul 2303m and Hoverla 2061m, the roof of the eastern arc.
        { name: "Carpathians (southern - Fagaras and Retezat)", core: 0.55, fringe: 1.5, pts: [[25.8, 45.5], [24.8, 45.4], [23.5, 45.4], [22.5, 45.4]] },
        { name: "Rodna and Chornohora", core: 0.55, fringe: 1.3, pts: [[24.5, 48.15], [25.0, 47.6]] },
    ...
    flatAreas: [
        ...
        // width of the peninsula, so they flattened the Apennine interior along with the shore.
        // Now each is a ribbon along the sea it belongs to and the spine keeps its hills; Rome,
    ...
    fallbackSites: [
        // European bank at the northern mouth of the Bosporus - this map had no Constantinople site.
