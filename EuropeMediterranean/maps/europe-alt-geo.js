...
export const GEO = {
    ...
    expectLand: {
        joined: [["Finland and Estonia, through Karelia", [23.8, 61.5], [24.75, 59.44]]],
        apart: [["Europe and China", "CIVILIZATION_ROME", "CIVILIZATION_QING"],
    ...
    distantLandsAnchors: [
        ...
        // Scandinavia and Finland are not distant on this map: Karelia joins Finland to Estonia
        // overland (see the Eastern Ocean in tools/eurasia-compressed/east-asia.mjs).
        [-21.9, 64.1],       // Iceland,
        ...
        [46.22, 52.22],   // East Asia mainland
        [61.22, 53.54],   // Honshu
        [56.04, 49.17],   // Kyushu
        [57.13, 50.21],   // Shikoku
        [62.91, 57.54],   // Hokkaido
        [66.14, 61.81],   // Sakhalin
        [57.1, 44.41],   // Taiwan
        [53.82, 42.26],   // Hainan
        // @east-asia:end
    ],
    ...
    resourceAreas: [
        // @east-asia:begin - generated by tools/eurasia-compressed/east-asia.mjs; edit that, not this
        { name: "Japan", density: 9, resources: ["RESOURCE_FISH", "RESOURCE_SILVER", "RESOURCE_GOLD", "RESOURCE_WHALES", "RESOURCE_SILK", "RESOURCE_HARDWOOD", "RESOURCE_PEARLS"], pts: [[56.62, 47.7], [58.76, 46.53], [60.53, 46.53], [62.31, 46.53], [64.09, 46.53], [65.86, 46.53], [67.64, 46.53], [65.6, 47.7], [66.88, 47.7], [68.16, 47.7], [65.11, 49.3], [63.52, 50.89], [64.52, 52.48], [65.51, 54.07], [66.46, 55.66], [66.41, 56.8], [65.73, 57.84], [65.88, 58.89], [64.49, 58.89], [63.09, 58.89], [61.7, 58.89], [61.39, 59.02], [60.17, 59.02], [58.96, 59.02], [57.74, 59.02], [56.53, 59.02], [55.31, 59.02], [54.88, 58.11], [54.68, 57.21], [53.68, 55.72], [53.32, 53.57], [53.4, 51.42], [53.64, 49.27], [55.04, 49.3]] },
        { name: "Korea", density: 9, resources: ["RESOURCE_IRON", "RESOURCE_GOLD", "RESOURCE_SILK", "RESOURCE_FISH", "RESOURCE_KAOLIN"], pts: [[50.55, 48.86], [51.94, 48.86], [53.33, 48.86], [54.33, 48.14], [54.21, 50.78], [54.06, 53.42], [54.5, 56.06], [55.42, 58.37], [55.73, 57.38], [54.38, 57.38], [53.02, 57.38], [51.67, 57.38], [51.18, 56.16], [49.38, 54.51], [49.42, 52.63], [50.02, 50.74]] },
        ...
        { name: "North China", density: 9, resources: ["RESOURCE_SILK", "RESOURCE_IRON", "RESOURCE_COAL", "RESOURCE_SALT", "RESOURCE_HORSES", "RESOURCE_COTTON", "RESOURCE_KAOLIN"], pts: [[45.43, 47.7], [46.09, 47.7], [46.75, 47.7], [47.41, 47.7], [48.07, 47.7], [48.73, 47.7], [49.38, 47.7], [50.04, 47.7], [50.7, 47.7], [51.36, 47.7], [52.36, 47.7], [53.65, 47.7], [52.53, 49.14], [50.55, 48.86], [50, 50.8], [49.38, 52.74], [49.39, 54.68], [51.2, 56.33], [49.8, 56.33], [48.54, 56.33], [47.42, 56.33], [46.31, 56.33], [45.19, 56.33], [44.08, 56.33], [42.97, 56.33], [41.85, 56.33], [40.74, 56.33], [39.62, 56.33], [38.51, 56.33], [39.13, 54.89], [39.84, 53.45], [41.45, 52.02], [42.89, 50.58], [44.27, 49.14]] },
        { name: "Mongolia", density: 11, resources: ["RESOURCE_HORSES", "RESOURCE_HIDES", "RESOURCE_WOOL", "RESOURCE_SALT", "RESOURCE_CAMELS"], pts: [[38.51, 56.33], [39.55, 56.33], [40.6, 56.33], [41.64, 56.33], [42.69, 56.33], [43.73, 56.33], [44.78, 56.33], [45.83, 56.33], [46.87, 56.33], [47.92, 56.33], [48.58, 57.54], [49.08, 58.4], [49.59, 59.25], [50.12, 60.23], [51.13, 61.96], [52.17, 63.57], [51.02, 63.57], [49.87, 63.57], [48.72, 63.57], [47.57, 63.57], [46.42, 63.57], [45.28, 63.57], [44.13, 63.57], [42.98, 63.57], [41.83, 63.57], [41.07, 61.96], [40.33, 60.23], [39.95, 59.25], [39.51, 58.4], [39.07, 57.54]] },
        { name: "Manchuria and the Amur", density: 11, resources: ["RESOURCE_FURS", "RESOURCE_HARDWOOD", "RESOURCE_HIDES", "RESOURCE_WILD_GAME", "RESOURCE_GOLD", "RESOURCE_IRON"], pts: [[47.92, 56.33], [49.04, 56.33], [50.43, 56.33], [51.83, 56.33], [53.23, 56.33], [54.27, 58.6], [56.29, 58.6], [58.31, 58.6], [60.33, 58.6], [62.36, 58.6], [64.38, 58.6], [66.4, 58.6], [64.43, 56.33], [65.83, 56.33], [67.23, 56.33], [66.77, 57.56], [66.26, 58.44], [66.78, 59.31], [67.65, 60.39], [69.18, 62.14], [70.76, 63.79], [72.52, 65.44], [73.41, 66.2], [72, 66.2], [70.59, 66.2], [69.18, 66.2], [67.77, 66.2], [66.35, 66.2], [64.94, 66.2], [63.53, 66.2], [62.12, 66.2], [60.71, 66.2], [59.3, 66.2], [57.89, 66.2], [56.48, 66.2], [55.09, 66.2], [53.78, 66.2], [52.46, 66.2], [51.15, 66.2], [49.83, 66.2], [48.51, 66.2], [47.2, 66.2], [45.88, 66.2], [44.56, 66.2], [43.25, 66.2], [42.75, 65.33], [41.83, 63.57], [42.98, 63.57], [44.13, 63.57], [45.28, 63.57], [46.42, 63.57], [47.57, 63.57], [48.72, 63.57], [49.87, 63.57], [51.02, 63.57], [52.17, 63.57], [51.13, 61.96], [50.12, 60.23], [49.59, 59.25], [49.08, 58.4], [48.58, 57.54]] },
        // @east-asia:end
    ...
    rivers: [
        // @east-asia:begin - generated by tools/eurasia-compressed/east-asia.mjs; edit that, not this
        { name: "Yellow River", pts: [[47.73, 53.66], [47.25, 52.8], [47, 51.24], [45.7, 51.24], [45.44, 51.07], [44.24, 52.63], [43.09, 55.1], [42.47, 56], [40.84, 56.16], [41.02, 54.68], [41.18, 53.37], [41.64, 52.39]] },
        ...
        { name: "Amur", pts: [[67.23, 64.53], [62.78, 62.34], [60.06, 60.39], [57.08, 59.82], [56.35, 62.07], [55.89, 64.62]] },
    ...
    land: [
        // @east-asia:begin - generated by tools/eurasia-compressed/east-asia.mjs; edit that, not this
        { name: "Kyushu", late: true, pts: [[54.61, 49.75], [54.04, 47.99], [54.38, 48.07], [54.71, 48.14], [55.49, 50.21], [56.04, 49.86], [56.57, 49.29], [57.14, 48.71], [57.47, 48.14], [57.83, 47.56], [57.77, 47.33], [57.71, 47.1], [56.9, 47.45], [56.51, 47.91], [56.15, 48.37], [55.66, 48.71], [55.19, 49.06]] },
        ...
        { name: "Hokkaido", late: true, pts: [[61.33, 56.26], [61.81, 56.45], [62.21, 56.55], [62.35, 56.84], [62.44, 57.06], [62.84, 56.95], [63.25, 56.84], [63.61, 56.76], [63.94, 56.64], [64.2, 56.95], [64.43, 57.22], [64.87, 57.33], [65.29, 57.43], [65.03, 57.7], [64.79, 57.97], [64.45, 57.92], [64.11, 57.86], [63.7, 57.97], [63.29, 58.08], [62.85, 58.32], [62.64, 58.56], [62.1, 58.51], [62.09, 58.24], [62.24, 57.97], [62.18, 57.7], [62.13, 57.43], [61.75, 57.43], [61.38, 57.43], [61.32, 57.16], [61.27, 56.9], [61.34, 56.64]] },
        { name: "Sakhalin", late: true, pts: [[63.41, 59.07], [63.66, 59.32], [63.91, 59.58], [64.16, 59.91], [64.6, 60.48], [65.1, 61.15], [65.62, 61.81], [66.04, 62.25], [66.47, 62.69], [66.91, 63.13], [67.37, 63.63], [67.85, 64.12], [68.35, 64.62], [69.01, 65.11], [69.7, 65.59], [69.48, 65.19], [69.28, 64.8], [68.62, 64.18], [67.99, 63.57], [67.55, 63.13], [67.13, 62.69], [66.72, 62.25], [66.62, 61.87], [66.51, 61.46], [66.41, 61.05], [66.09, 61.1], [65.78, 61.15], [65.26, 60.64], [64.75, 60.13], [64.4, 59.82], [64.53, 59.61], [64.65, 59.39], [64.36, 59.25], [63.95, 59.3], [63.68, 59.18]] },
    ...
    lakes: [
        // @east-asia:begin - generated by tools/eurasia-compressed/east-asia.mjs; edit that, not this
        [31.3, 60.85, 1.0, "Ladoga"], [35.4, 61.9, 0.8, "Onega"],
        // @east-asia:end
 [13.2, 58.9, 0.9, "Vanern"], [14.5, 58.3, 0.5, "Vattern"],
    ...
    ranges: [
        // @east-asia:begin - generated by tools/eurasia-compressed/east-asia.mjs; edit that, not this
        { name: "Hengduan (the Sichuan rim)", core: 0.7, fringe: 1.3, pts: [[49.25, 44.74], [48.35, 45.37], [47.44, 45.99], [46.88, 46.6], [46.28, 47.29], [45.29, 48.53], [44.2, 49.76], [43.11, 50.99], [41.95, 52.22]] },
        { name: "Qinling", core: 0.6, fringe: 1.3, pts: [[43.76, 50.41], [44.32, 50.5], [44.88, 50.58], [45.54, 50.5], [46.2, 50.41]] },
        { name: "Taihang", core: 0.4, fringe: 1.1, pts: [[46.46, 51.56], [45.91, 52.51], [45.35, 53.45], [45.45, 54.4], [45.66, 55.34]] },
        { name: "Yin Shan", core: 0.3, fringe: 1, pts: [[40.84, 56.49], [41.99, 56.49], [43.13, 56.49], [43.97, 56.74], [44.82, 56.98]] },
        { name: "Greater Khingan", core: 0.4, fringe: 1.2, pts: [[48.76, 57.85], [49.68, 58.67], [50.6, 59.49], [51.54, 60.62], [52.87, 62.25], [53.44, 63.35], [54.05, 64.45]] },
        { name: "Changbai", core: 0.5, fringe: 1.1, pts: [[53.12, 56.74], [54.05, 57.15], [55.09, 57.62]] },
        { name: "Sikhote-Alin", core: 0.4, fringe: 1.1, pts: [[57.44, 58.08], [58.27, 58.55], [59.37, 59.02], [60.56, 59.61], [61.91, 60.39]] },
        ...
        { name: "Khentii", core: 0.3, fringe: 1, pts: [[42.88, 59.96], [43.62, 60.29], [44.4, 60.67]] },
        { name: "Stanovoy", core: 0.15, fringe: 1, pts: [[48.57, 65.33], [49.63, 65.3], [50.69, 65.27], [51.74, 65.24], [52.8, 65.21], [53.85, 65.18], [54.93, 65.15], [56.06, 65.19], [57.2, 65.22], [58.33, 65.26], [59.47, 65.29], [60.61, 65.33]] },
        { name: "Taebaek", core: 0.35, fringe: 1, pts: [[52.75, 53.96], [53.14, 52.18], [53.47, 50.85]] },
        { name: "Japanese Alps", core: 0.6, fringe: 1.1, pts: [[59.73, 52.39], [60.61, 53.2], [61.37, 54]] },
        { name: "Ou Mountains", core: 0.35, fringe: 0.9, pts: [[63.75, 54.58], [64.45, 55.73], [65.2, 56.88], [66.19, 58.6]] },
        { name: "Hidaka", core: 0.3, fringe: 0.8, pts: [[63.3, 56.9], [63.34, 57.43]] },
    ...
    biomeAreas: [
        ...
        // @east-asia:begin - generated by tools/eurasia-compressed/east-asia.mjs; edit that, not this
        { name: "East Asia", biome: "G", pts: [[51.92, 41.69], [52.43, 41.69], [52.95, 41.69], [53.46, 41.69], [53.98, 41.69], [54.49, 41.69], [55.01, 41.69], [55.52, 41.69], [56.03, 41.69], [56.55, 41.69], [57.06, 41.69], [57.58, 41.69], [58.09, 41.69], [58.6, 41.69], [59.12, 41.69], [59.63, 41.69], [60.15, 41.69], [60.66, 41.69], [61.18, 41.69], [61.69, 41.69], [62.2, 41.69], [62.72, 41.69], [63.23, 41.69], [63.44, 42.14], [65.09, 43.05], [67.54, 43.97], [70.05, 44.88], [69.03, 45.8], [69.06, 46.7], [68.31, 47.83], [65.18, 49.43], [63.88, 51.03], [64.92, 52.63], [65.94, 54.23], [66.92, 55.83], [66.95, 57.31], [66.37, 58.22], [66.65, 59.14], [67.41, 60.1], [69, 61.94], [70.63, 63.66], [72.45, 65.37], [73.41, 66.2], [72, 66.2], [70.59, 66.2], [69.18, 66.2], [67.77, 66.2], [66.35, 66.2], [64.94, 66.2], [63.53, 66.2], [62.12, 66.2], [60.71, 66.2], [59.3, 66.2], [57.89, 66.2], [56.48, 66.2], [55.09, 66.2], [53.78, 66.2], [52.46, 66.2], [51.15, 66.2], [49.83, 66.2], [48.51, 66.2], [47.2, 66.2], [45.88, 66.2], [44.56, 66.2], [43.25, 66.2], [42.77, 65.37], [41.87, 63.66], [41.06, 61.94], [40.28, 60.1], [39.9, 59.14], [39.42, 58.22], [38.96, 57.31], [38.72, 55.83], [39.41, 54.23], [40.76, 52.63], [42.45, 51.03], [43.99, 49.43], [45.34, 47.83], [46.11, 46.7], [46.97, 45.8], [48.35, 44.88], [49.81, 43.97], [51.24, 43.05], [52.02, 42.14]] },
        ...
        { name: "North China Plain and the Loess", biome: "P", pts: [[43.67, 50.17], [44.44, 50.17], [45.21, 50.17], [45.98, 50.17], [46.75, 50.17], [47.52, 50.17], [48.29, 50.17], [49.06, 50.17], [48.86, 51.32], [48.65, 52.47], [48.49, 53.62], [48.88, 54.77], [49.4, 55.92], [48.4, 55.98], [47.46, 56.05], [46.51, 56.12], [45.56, 56.19], [44.6, 56.26], [43.64, 56.33], [42.77, 56.16], [41.91, 56], [41.07, 55.83], [40.23, 55.67], [39.41, 55.51], [39.95, 54.17], [41.01, 52.84], [42.42, 51.5]] },
        { name: "Mongolian steppe", biome: "P", pts: [[39.25, 55.92], [40.22, 56.09], [41.21, 56.27], [42.29, 56.44], [43.44, 56.62], [44.6, 56.8], [45.75, 56.97], [46.92, 57.15], [47.9, 57.62], [48.89, 58.08], [49.46, 59.02], [49.97, 59.96], [51.04, 61.81], [49.99, 62.03], [48.94, 62.25], [47.88, 62.47], [46.81, 62.69], [45.73, 62.91], [44.65, 63.13], [43.55, 63.35], [42.46, 63.57], [41.65, 61.88], [40.86, 60.07], [40.48, 59.14], [40.01, 58.24], [39.55, 57.34]] },
        { name: "Gobi", biome: "D", pts: [[39.31, 55.75], [40.17, 56.06], [41.07, 56.37], [42.22, 56.68], [43.38, 56.98], [44.42, 57.57], [45.42, 58.08], [44.52, 58.36], [43.61, 58.65], [42.7, 58.93], [41.86, 58.8], [41.01, 58.68], [40.17, 58.55], [39.79, 57.82], [39.4, 57.04]] },
        { name: "Manchuria", biome: "G", pts: [[47.92, 56.33], [49.06, 56.43], [50.48, 56.53], [51.9, 56.63], [53.3, 56.74], [54.69, 56.84], [56.08, 56.94], [57.45, 57.05], [58.81, 57.15], [58.73, 58.08], [59.06, 59.02], [59.7, 59.96], [61.06, 61.81], [59.79, 61.81], [58.53, 61.81], [57.27, 61.81], [56, 61.81], [54.74, 61.81], [53.48, 61.81], [52.22, 61.81], [51.04, 61.81], [50.05, 60.1], [49.57, 59.21], [49.06, 58.36], [48.57, 57.52]] },
        { name: "Siberian taiga", biome: "T", prob: 0.7, pts: [[41.83, 63.57], [43.08, 63.57], [44.34, 63.57], [45.59, 63.57], [46.84, 63.57], [48.1, 63.57], [49.35, 63.57], [50.6, 63.57], [51.85, 63.57], [53.11, 63.57], [54.43, 63.57], [55.77, 63.57], [57.11, 63.57], [58.46, 63.57], [59.8, 63.57], [61.14, 63.57], [62.49, 63.57], [63.83, 63.57], [65.17, 63.57], [66.51, 63.57], [67.86, 63.57], [69.2, 63.57], [70.54, 63.57], [72.4, 65.33], [73.41, 66.2], [72, 66.2], [70.59, 66.2], [69.18, 66.2], [67.77, 66.2], [66.35, 66.2], [64.94, 66.2], [63.53, 66.2], [62.12, 66.2], [60.71, 66.2], [59.3, 66.2], [57.89, 66.2], [56.48, 66.2], [55.09, 66.2], [53.78, 66.2], [52.46, 66.2], [51.15, 66.2], [49.83, 66.2], [48.51, 66.2], [47.2, 66.2], [45.88, 66.2], [44.56, 66.2], [43.25, 66.2], [42.75, 65.33]] },
        // @east-asia:end
    ],
    ...
    rainAreas: [
        ...
        { name: "Tihamah (Red Sea coast)", rain: 95, pts: [[35.0, 28.8], [37.6, 28.8], [39.6, 25.0], [41.6, 20.5],
            ...
            [40.1, 20.5], [38.1, 25.0], [36.1, 28.8], [33.5, 28.8]] },
        // @east-asia:begin - generated by tools/eurasia-compressed/east-asia.mjs; edit that, not this
        { name: "East Asia", rain: 110, pts: [[51.92, 41.69], [52.43, 41.69], [52.95, 41.69], [53.46, 41.69], [53.98, 41.69], [54.49, 41.69], [55.01, 41.69], [55.52, 41.69], [56.03, 41.69], [56.55, 41.69], [57.06, 41.69], [57.58, 41.69], [58.09, 41.69], [58.6, 41.69], [59.12, 41.69], [59.63, 41.69], [60.15, 41.69], [60.66, 41.69], [61.18, 41.69], [61.69, 41.69], [62.2, 41.69], [62.72, 41.69], [63.23, 41.69], [63.44, 42.14], [65.09, 43.05], [67.54, 43.97], [70.05, 44.88], [69.03, 45.8], [69.06, 46.7], [68.31, 47.83], [65.18, 49.43], [63.88, 51.03], [64.92, 52.63], [65.94, 54.23], [66.92, 55.83], [66.95, 57.31], [66.37, 58.22], [66.65, 59.14], [67.41, 60.1], [69, 61.94], [70.63, 63.66], [72.45, 65.37], [73.41, 66.2], [72, 66.2], [70.59, 66.2], [69.18, 66.2], [67.77, 66.2], [66.35, 66.2], [64.94, 66.2], [63.53, 66.2], [62.12, 66.2], [60.71, 66.2], [59.3, 66.2], [57.89, 66.2], [56.48, 66.2], [55.09, 66.2], [53.78, 66.2], [52.46, 66.2], [51.15, 66.2], [49.83, 66.2], [48.51, 66.2], [47.2, 66.2], [45.88, 66.2], [44.56, 66.2], [43.25, 66.2], [42.77, 65.37], [41.87, 63.66], [41.06, 61.94], [40.28, 60.1], [39.9, 59.14], [39.42, 58.22], [38.96, 57.31], [38.72, 55.83], [39.41, 54.23], [40.76, 52.63], [42.45, 51.03], [43.99, 49.43], [45.34, 47.83], [46.11, 46.7], [46.97, 45.8], [48.35, 44.88], [49.81, 43.97], [51.24, 43.05], [52.02, 42.14]] },
        ...
        { name: "Mongolian steppe", rain: 45, pts: [[39.25, 55.92], [40.22, 56.09], [41.21, 56.27], [42.29, 56.44], [43.44, 56.62], [44.6, 56.8], [45.75, 56.97], [46.92, 57.15], [47.9, 57.62], [48.89, 58.08], [49.46, 59.02], [49.97, 59.96], [51.04, 61.81], [49.99, 62.03], [48.94, 62.25], [47.88, 62.47], [46.81, 62.69], [45.73, 62.91], [44.65, 63.13], [43.55, 63.35], [42.46, 63.57], [41.65, 61.88], [40.86, 60.07], [40.48, 59.14], [40.01, 58.24], [39.55, 57.34]] },
        { name: "Gobi", rain: 15, pts: [[39.31, 55.75], [40.17, 56.06], [41.07, 56.37], [42.22, 56.68], [43.38, 56.98], [44.42, 57.57], [45.42, 58.08], [44.52, 58.36], [43.61, 58.65], [42.7, 58.93], [41.86, 58.8], [41.01, 58.68], [40.17, 58.55], [39.79, 57.82], [39.4, 57.04]] },
        { name: "Manchuria", rain: 100, pts: [[47.92, 56.33], [49.06, 56.43], [50.48, 56.53], [51.9, 56.63], [53.3, 56.74], [54.69, 56.84], [56.08, 56.94], [57.45, 57.05], [58.81, 57.15], [58.73, 58.08], [59.06, 59.02], [59.7, 59.96], [61.06, 61.81], [59.79, 61.81], [58.53, 61.81], [57.27, 61.81], [56, 61.81], [54.74, 61.81], [53.48, 61.81], [52.22, 61.81], [51.04, 61.81], [50.05, 60.1], [49.57, 59.21], [49.06, 58.36], [48.57, 57.52]] },
        { name: "Siberian taiga", rain: 90, pts: [[41.83, 63.57], [43.08, 63.57], [44.34, 63.57], [45.59, 63.57], [46.84, 63.57], [48.1, 63.57], [49.35, 63.57], [50.6, 63.57], [51.85, 63.57], [53.11, 63.57], [54.43, 63.57], [55.77, 63.57], [57.11, 63.57], [58.46, 63.57], [59.8, 63.57], [61.14, 63.57], [62.49, 63.57], [63.83, 63.57], [65.17, 63.57], [66.51, 63.57], [67.86, 63.57], [69.2, 63.57], [70.54, 63.57], [72.4, 65.33], [73.41, 66.2], [72, 66.2], [70.59, 66.2], [69.18, 66.2], [67.77, 66.2], [66.35, 66.2], [64.94, 66.2], [63.53, 66.2], [62.12, 66.2], [60.71, 66.2], [59.3, 66.2], [57.89, 66.2], [56.48, 66.2], [55.09, 66.2], [53.78, 66.2], [52.46, 66.2], [51.15, 66.2], [49.83, 66.2], [48.51, 66.2], [47.2, 66.2], [45.88, 66.2], [44.56, 66.2], [43.25, 66.2], [42.75, 65.33]] },
        // @east-asia:end
    ],
    ...
    volcanoes: [
        ...
        [40.7, 13.6, "Erta Ale"],
        // @east-asia:begin - generated by tools/eurasia-compressed/east-asia.mjs; edit that, not this
        [61.2, 52.12, "Fuji"], [54.04, 57.15, "Paektu"],
        // @east-asia:end
    ],
    ...
    tsl: {
        ...
        CIVILIZATION_QING: [46.25, 55.42],   // Beijing - the Qing capital
        ...
        CIVILIZATION_MEIJI: [62.11, 52.5],   // Tokyo
        CIVILIZATION_SILLA: [52.77, 51.41],   // the upper Nakdong, Silla's heartland - Gyeongju itself lands 4 hexes from Kyoto across the compressed strait
        CIVILIZATION_GORYEO: [51.12, 53.26],   // Kaesong - the Goryeo capital
        CIVILIZATION_JOSEON: [51.5, 52.82],   // Hanseong (Seoul) - the Joseon capital
        CIVILIZATION_MONGOLIA: [42.51, 59.91],   // the Tuul valley, the Khans' home steppe (Karakorum lies west of the cut)
        CIVILIZATION_RUSSIA: [56.7, 57.67],   // Vladivostok, Russia's Pacific port
        // @east-asia:end
    ...
    fallbackSites: [
        ...
        // @east-asia:begin - generated by tools/eurasia-compressed/east-asia.mjs; edit that, not this
        [53.87, 44.1, "Guangzhou"], [49.15, 47.78, "Wuhan"], [51.49, 47.52, "Hangzhou"], [47.01, 51.24, "Kaifeng"], [50.75, 56.98, "Shenyang"], [53.76, 58.9, "Harbin"], [50.51, 54.42, "Pyongyang"], [53.59, 50.08, "Busan"], [64.43, 55.46, "Sendai"], [62.14, 57.3, "Sapporo"], [54.67, 47.51, "Fukuoka"], [57.5, 44.99, "Taipei"], [52.06, 43.11, "Hanoi"], [56.04, 44.93, "Quanzhou"], [44.52, 55.57, "Datong"], [43.48, 56.18, "Hohhot"],
        // @east-asia:end
    ]
};
