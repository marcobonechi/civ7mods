// europe-alt-geo.js
// Geography for the "Eurasia Compressed" map (formerly "Europe & Mediterranean (Variant)").
//
// A full copy of europe-large-geo.js taken at mod version 39, forked so it can be edited freely
// without touching the original. The two files share nothing at runtime: europe-alt-map.js loads
// this one, europe-large-map.js loads the other. They do share the generator in
// europe-large-core.js, so a change there still affects both maps.
//
