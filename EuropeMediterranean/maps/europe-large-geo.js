...
export const GEO = {
    ...
    landBlobsLate: [
        // Funen and the Great Belt: a one-hex-wide land bridge joining Zealand (Copenhagen) to
        // Jutland, so Denmark is one country by land. The Oresund east of Zealand stays water, which
        // is what keeps Denmark in the home lands rather than joining Distant-Lands Scandinavia.
        [10.30, 55.50, 0.1, "Funen"], [11.00, 55.50, 0.1, "Great Belt isthmus"],
