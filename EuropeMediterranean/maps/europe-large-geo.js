...
export const GEO = {
    ...
    biomeBlobs: [
        [25.5, 29.2, 0.7, "G", 60, "Siwa"], [28.9, 28.3, 0.6, "G", 60, "Bahariya"], [27.9, 27.1, 0.6, "G", 60, "Farafra"],
    ...
    shallowLines: [
        { name: "Iceland-Faroe-Shetland", radius: 1.1, pts: [[-17.0, 63.8], [-12.0, 63.0], [-6.9, 62.0], [-2.5, 60.5], [1.48, 58.93]] },
        { name: "Faroe-Orkney", radius: 1.1, pts: [[-6.9, 62.0], [-3.5, 59.8], [-0.57, 57.95]] },
        { name: "Shetland-Norway", radius: 1.1, pts: [[1.48, 58.93], [3.4, 59.7], [5.3, 60.4]] }
    ],
    ...
    resourceAreas: [
        { name: "Greece and Aegean", density: 8, resources: ["RESOURCE_MARBLE", "RESOURCE_WINE", "RESOURCE_SILVER", "RESOURCE_FISH", "RESOURCE_CITRUS", "RESOURCE_WOOL"], pts: [[19.3, 34.5], [28.5, 34.5], [28.5, 41.8], [19.3, 41.8]] },
        { name: "Italy", density: 8, resources: ["RESOURCE_WINE", "RESOURCE_MARBLE", "RESOURCE_TRUFFLES", "RESOURCE_WOOL", "RESOURCE_IRON", "RESOURCE_SALT", "RESOURCE_FISH", "RESOURCE_CITRUS", "RESOURCE_CLAY"], pts: [[6.5, 36.4], [19.0, 36.4], [19.0, 47.0], [6.5, 47.0]] },
        ...
        { name: "Mesopotamia", density: 8, resources: ["RESOURCE_DATES", "RESOURCE_CLAY", "RESOURCE_PITCH", "RESOURCE_GYPSUM", "RESOURCE_WOOL", "RESOURCE_HORSES"], pts: [[38.0, 29.5], [48.5, 29.5], [48.5, 37.5], [38.0, 37.5]] },
        { name: "Arabia", density: 13, resources: ["RESOURCE_INCENSE", "RESOURCE_CAMELS", "RESOURCE_DATES", "RESOURCE_PEARLS", "RESOURCE_SALT", "RESOURCE_OIL"], pts: [[36.0, 12.0], [56.0, 12.0], [56.0, 30.0], [36.0, 30.0]] },
        { name: "Persia", density: 9, resources: ["RESOURCE_HORSES", "RESOURCE_LAPIS_LAZULI", "RESOURCE_SILK", "RESOURCE_GOLD", "RESOURCE_CAMELS", "RESOURCE_SALT", "RESOURCE_OIL", "RESOURCE_RUBIES"], pts: [[44.0, 26.0], [60.0, 26.0], [60.0, 40.0], [44.0, 40.0]] },
        ...
        { name: "Scandinavia", density: 11, resources: ["RESOURCE_FURS", "RESOURCE_FISH", "RESOURCE_WHALES", "RESOURCE_IRON", "RESOURCE_HARDWOOD", "RESOURCE_WILD_GAME"], pts: [[4.0, 55.0], [31.0, 55.0], [31.0, 72.0], [4.0, 72.0]] },
        ...
        { name: "Britain", density: 9, resources: ["RESOURCE_TIN", "RESOURCE_WOOL", "RESOURCE_COAL", "RESOURCE_IRON", "RESOURCE_FISH", "RESOURCE_HIDES"], pts: [[-6.5, 49.4], [5.0, 49.4], [5.0, 59.6], [-6.5, 59.6]] },
        ...
        { name: "Germany and Central Europe", density: 9, resources: ["RESOURCE_IRON", "RESOURCE_COAL", "RESOURCE_SALT", "RESOURCE_HARDWOOD", "RESOURCE_HIDES", "RESOURCE_SILVER", "RESOURCE_WOOL", "RESOURCE_WILD_GAME"], pts: [[6.0, 46.5], [19.0, 46.5], [19.0, 55.0], [6.0, 55.0]] },
        ...
        { name: "Sahara", density: 18, resources: ["RESOURCE_SALT", "RESOURCE_CAMELS", "RESOURCE_DATES", "RESOURCE_GOLD", "RESOURCE_OIL"], pts: [[-18.0, 17.5], [36.0, 17.5], [36.0, 29.0], [-18.0, 29.0]] },
    ...
    rivers: [
        ...
        { name: "Nile", pts: [[31.0, 31.2], [31.2, 30.0], [31.2, 27.2], [32.6, 25.7], [32.9, 24.1], [31.5, 21.8], [30.8, 19.4], [32.0, 17.6], [32.5, 15.6]] },
        { name: "White Nile", pts: [[32.5, 15.6], [31.0, 14.6], [29.3, 14.0], [27.5, 13.8], [26.5, 13.2], [25.5, 12.8]] },
        ...
        // Europe
        { name: "Tiber", pts: [[12.3, 41.75], [12.5, 41.9], [12.8, 42.3]] },
        ...
        { name: "Rhine", pts: [[4.5, 51.9], [6.0, 51.8], [6.95, 50.95], [8.3, 50.0], [7.8, 48.6], [7.6, 47.6], [8.6, 47.6]] },
        { name: "Danube", pts: [[9.7, 48.3], [10.5, 48.5], [12.1, 49.0], [13.5, 48.6], [14.3, 48.3], [16.4, 48.2], [19.0, 47.5], [19.0, 46.0], [20.5, 44.8], [22.5, 44.6], [24.0, 43.8], [26.0, 43.9], [28.0, 44.2], [29.5, 45.2]] },
        { name: "Rhone", pts: [[4.7, 43.4], [4.8, 43.9], [4.8, 45.0], [4.8, 45.8]] },
        // Garonne: Gironde estuary at Bordeaux up to Toulouse (south-west France)
        { name: "Garonne", pts: [[-1.1, 45.6], [-0.6, 44.85], [0.3, 44.4], [1.4, 43.6]] },
        ...
        // Iberia
        { name: "Ebro", pts: [[0.85, 40.7], [0.0, 41.3], [-0.9, 41.65], [-2.5, 42.4]] },
        ...
        { name: "Don", pts: [[39.2, 51.7], [40.5, 50.0], [42.0, 49.0], [41.0, 48.0], [39.7, 47.2], [38.6, 46.9], [38.0, 46.6]] },
        // Africa
    ...
    landBlobs: [
        ...
        [25.4, 36.4, 0.5, "Santorini"], [23.75, 38.05, 0.7, "Attica"], [23.45, 38.45, 0.8, "Boeotia"], [19.85, 39.65, 0.5, "Corfu"], [20.55, 38.2, 0.5, "Kefalonia"], [25.2, 39.9, 0.5, "Lemnos"],
        [14.45, 35.9, 0.5, "Malta"], [-6.9, 62.0, 0.5, "Faroe"], [1.48, 58.93, 0.5, "Shetland"], [-0.57, 57.95, 0.5, "Orkney"],
    ...
    ranges: [
        ...
        { name: "Hejaz-Asir", core: 0.3, fringe: 1.1, pts: [[36.5, 28.0], [38.5, 26.0], [40.5, 22.0], [41.8, 19.5], [43.0, 17.5]] },
        { name: "Yemen Highlands", core: 0.6, fringe: 1.3, pts: [[43.3, 17.0], [44.0, 15.0], [45.3, 13.6]] },
    ...
    volcanoes: [
        [15.0, 37.75, "Etna"], [14.43, 40.82, "Vesuvius"], [-19.31, 63.59, "Hekla"], [25.4, 36.4, "Santorini"],
    ...
    fallbackSites: [
        ...
        [32.9, 39.9, "Ankara"], [36.3, 33.5, "Damascus"], [20.5, 44.8, "Belgrade"], [44.8, 41.7, "Tbilisi"],
