// Etruscans: make the shell find our loose PNGs where it looks for package textures.
//
...
(function () {
    const CONFIG = {
        modId: "etruscans",
        civ: "etruscans",                        // the <civ> the shell builds its names from
        civType: "CIVILIZATION_ETRUSCANS",
        panel: "bg-panel-etruscans.png",
